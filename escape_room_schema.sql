...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-03-2025 a las 20:53:23
...
CREATE TABLE `users` (
  ...
  `user_adress_street` varchar(100) DEFAULT NULL,
  `user_adress_number` int(11) DEFAULT NULL,
  `user_adress_floor` char(20) DEFAULT NULL,
  `user_adress_door` char(20) DEFAULT NULL,
...
ALTER TABLE `decoration_items`
  ...
  ADD UNIQUE KEY `name` (`decoration_item_name`);
...
ALTER TABLE `notifications`
  ...
  ADD KEY `fk_notification_room` (`room_id`);
...
--
ALTER TABLE `notifications`
  ADD CONSTRAINT `fk_notification_room` FOREIGN KEY (`room_id`) REFERENCES `rooms` (`room_id`),
